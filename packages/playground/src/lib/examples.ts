...
`,
  },
  {
    ...
    description: 'Example output from Claude using TaskML',
    category: 'ai-agents',
    recommendedView: 'list',
    featured: true,
    tags: ['claude', 'integration', 'example'],
    content: `@project Product Launch
@due 2025-03-01
...
- Generated by Claude with TaskML system prompt
- Copy to playground to visualize
`,
  },
  {
    id: 'chatgpt-sprint',
    title: 'ChatGPT Sprint Plan',
    description: 'Sprint planning output from ChatGPT',
    category: 'ai-agents',
    recommendedView: 'kanban',
    tags: ['chatgpt', 'sprint', 'integration'],
    content: `@project Mobile App
@sprint Sprint 5
...
- Generated by ChatGPT with TaskML system prompt
`,
  },
  {
    id: 'cursor-refactor',
    title: 'Cursor Refactoring',
    description: 'Code refactoring task list from Cursor',
    category: 'ai-agents',
    recommendedView: 'tree',
    tags: ['cursor', 'refactor', 'coding'],
    content: `@project Auth Refactor
...
- Generated by Cursor with TaskML system prompt
- Each phase tracked for visibility
`,
  },
  {
    id: 'research-agent',
