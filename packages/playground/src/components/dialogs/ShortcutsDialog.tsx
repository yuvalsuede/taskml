...
const SHORTCUT_GROUPS: ShortcutGroup[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { keys: ['Ctrl', '2'], description: 'Kanban view' },
      { keys: ['Ctrl', '3'], description: 'Tree view' },
      { keys: ['Ctrl', '4'], description: 'Timeline view' },
      { keys: ['Ctrl', '5'], description: 'Table view' },
      { keys: ['Ctrl', '6'], description: 'Graph view' },
      { keys: ['Ctrl', '7'], description: 'Summary view' },
    ],
  },
  {
    title: 'Zoom',
